...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		title    = 'Sheriff - Menu Intéraction',
		align    = 'top-left',
		elements = {
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		...
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("Sheriff Station - Paleto Bay")
		...
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("Sheriff Station - Sandy Shores")
    ...
    if isRadarPlaced then -- remove the previous radar if it exists, only one radar per cop
        ...
        if maxSpeed ~= nil then -- maxSpeed = nil only if the player hasn't entered a valid number
		  ...
		  SetModelAsNoLongerNeeded("prop_cctv_pole_01a")
            ...
            Radar = CreateObject(1927491455, RadarPos.x, RadarPos.y, RadarPos.z - 7, true, true, true) 
