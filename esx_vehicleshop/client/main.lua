...
AddEventHandler('esx_vehicleshop:hasEnteredMarker', function (zone)
	...
	elseif zone == 'BossActions' and Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'cardealer' and PlayerData.job.grade_name == 'boss' then
